...
import 'package:pora/core/features/onboarding/presentation/screen/onboarding_slider_screen.dart'
    as _i17;
import 'package:pora/core/features/predictions_ai/presentation/screen/ai_config_screen.dart'
    as _i3;
...
/// generated route for
/// [_i3.AiConfigPage]
class AiConfigRoute extends _i26.PageRouteInfo<void> {
  const AiConfigRoute({List<_i26.PageRouteInfo>? children})
    : super(AiConfigRoute.name, initialChildren: children);

  static const String name = 'AiConfigRoute';

  static _i26.PageInfo page = _i26.PageInfo(
    name,
    builder: (data) {
      return const _i3.AiConfigPage();
    },
  );
}
