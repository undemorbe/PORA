...
class GetOtp {
  ...
  Future<Either<Failure, Success>> callGettingOtp({required AuthTypes authType, required String login }) async {
    return Right(ServerSuccess(
'200', networkOtp.getOtp(authType: authType, login: login)
    ) );
  }
}
